...
1 日生成一次正式 release。Linux 发布配置包；Windows 同时发布 noVS、标准版和 vsNV
叠加包。Linux 配置包不捆绑播放器二进制，用户自行安装 mpv、yt-dlp 和其它依赖。Windows 的 mpv、umpv、yt-dlp、VapourSynth、K7sfunc 和
